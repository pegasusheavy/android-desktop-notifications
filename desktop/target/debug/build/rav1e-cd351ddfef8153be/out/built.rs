...
#[allow(dead_code)]
pub static RUSTC: &str = "/home/joseph/.local/share/rustup/toolchains/nightly-x86_64-unknown-linux-gnu/bin/rustc";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub static RUSTDOC: &str = "/home/joseph/.local/share/rustup/toolchains/nightly-x86_64-unknown-linux-gnu/bin/rustdoc";
#[allow(clippy::needless_raw_string_hashes)]
...
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/home/joseph/.local/share/rustup/toolchains/nightly-x86_64-unknown-linux-gnu/bin/rustc -V`"#]
#[allow(dead_code)]
pub static RUSTC_VERSION: &str = "rustc 1.95.0-nightly (0a3cd3b6b 2026-01-18)";
#[allow(clippy::needless_raw_string_hashes)]
#[doc=r#"The output of `/home/joseph/.local/share/rustup/toolchains/nightly-x86_64-unknown-linux-gnu/bin/rustdoc -V`; empty string if `/home/joseph/.local/share/rustup/toolchains/nightly-x86_64-unknown-linux-gnu/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
pub static RUSTDOC_VERSION: &str = "rustdoc 1.95.0-nightly (0a3cd3b6b 2026-01-18)";
#[allow(clippy::needless_raw_string_hashes)]
